...
updated: 2026-05-03T12:13:44
permalink: /Dev/kubernetes/why-k8s-is-needed
---

> [!abstract]+ TL;DR
> - 컨테이너만으로는 단일 서버 한계, 수동 관리, 배포/롤백 문제 존재
> - k8s는 다수 서버를 하나의 클러스터로 묶는 컨테이너 오케스트레이션 플랫폼
> - Control Plane과 Node 컴포넌트 구조 및 자동화 배포, 자가 치유 등 핵심 기능 정리
