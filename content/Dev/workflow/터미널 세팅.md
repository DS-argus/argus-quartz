...
updated: 2026-05-12T23:12:56
permalink: /Dev/workflow/terminal-setup
---

> [!abstract]+ TL;DR
> - CLI 중심 workflow로 반복 작업과 컨텍스트 전환을 줄이는 터미널 세팅 정리
> - 터미널 에뮬레이터·CLI/TUI 도구·zsh 플러그인별 용도와 설치 명령어 제공
> - Ghostty, yazi, lazygit, uv 등 실사용 도구 구성 소개
...
- 설치
  ...
  ```
- 단축키 : zsh에 추가해야 함 
	- `CTRL+T` : 현재 디렉토리 기준 파일/디렉토리 경로 문자열로 붙이기 
	- `CTRL+R` : 터미널 입력 히스토리 목록 문자열로 붙이기 
	- `ALT+C` or `ESC+C` : 현재 디렉토리 기준 폴더 목록으로 이동  
