...
updated: 2026-06-14T00:29:14
permalink: /Dev/linux/bash-shell-script-1-basics
---
> [!abstract]+ TL;DR
> - Bash의 명령어 해석 과정과 특수 문자 역할을 알면 스크립트 독해·디버깅이 쉬워짐
> - 변수, 따옴표 규칙, 파라미터 확장, 문자열 조작은 모든 스크립트의 기본 도구
> - 배열(인덱스/연관)과 glob/정규식 패턴 매칭까지 다루는 1편
...
##### [[Bash Shell Script 2 - 제어 흐름과 IO#4. 리다이렉션과 파일 디스크립터|리다이렉션과 파이프]]
