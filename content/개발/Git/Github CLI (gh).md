...
---
> [!note] gh란?
>- GitHub에서 공식 제공하는 **CLI(Command Line Interface)** 도구로 터미널에서 _GitHub와 관련된 작업(예: PR 생성, 이슈 관리, 저장소 복제 등)_ 을 처리할 수 있게 해주는 툴
>- gh는 **GitHub 웹 인터페이스에서 하던 대부분의 작업을 CLI에서 가능하게 해주는 툴**로,  git 자체를 대체하는 것이 아니라 GitHub와의 연동 작업을 훨씬 효율적 개선
