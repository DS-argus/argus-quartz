...
updated: 2026-03-10T20:34:42
permalink: /Obsidian/Quartz/auto-organize-obsidian-blog-attachments
---

> [!abstract]+ TL;DR
> - `content/Files` 첨부파일 관리를 `.gitignore` 대신 `.git/info/exclude` 로컬 전용 규칙으로 전환
> - 글에서 실제 참조하는 첨부만 자동으로 stage하는 `scripts/stage-content.mjs` 추가
> - `.gitignore` 규칙이 Quartz 빌드 입력까지 제외해 블로그 이미지가 깨졌던 원인 분석과 조치 기록
